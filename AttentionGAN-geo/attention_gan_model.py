...
class AttentionGANModel(BaseModel):
	...
	def forward(self):
		...
		self.i1_b, self.i2_b, self.i3_b, self.i4_b, self.i5_b, self.i6_b, self.i7_b, self.i8_b, self.i9_b, self.i10_b = self.netG_A(
			self.real_A)  # G_A(A)
		...
		self.i1_a, self.i2_a, self.i3_a, self.i4_a, self.i5_a, self.i6_a, self.i7_a, self.i8_a, self.i9_a, self.i10_a = self.netG_B(
			self.real_B)  # G_B(B)
