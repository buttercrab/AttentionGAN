...
class CycleGAN1Model(BaseModel):
	...
	def __init__(self, opt):
		...
		visual_names_A = ['real_A', 'fake_B', 'rec_A', 'o1_b', 'o2_b', 'o3_b', 'o4_b', 'o5_b', 'o6_b', 'o7_b', 'o8_b', 'o9_b',
		                  'o10_b',
		                  'a1_b', 'a2_b', 'a3_b', 'a4_b', 'a5_b', 'a6_b', 'a7_b', 'a8_b', 'a9_b', 'a10_b', 'i1_b', 'i2_b', 'i3_b',
		                  'i4_b', 'i5_b',
		                  'i6_b', 'i7_b', 'i8_b', 'i9_b', 'rec_A_o1', 'rec_A_o2', 'rec_A_o3', 'rec_A_o4', 'rec_A_o5', 'rec_A_o6',
		                  'rec_A_o7', 'rec_A_o8', 'rec_A_o9', 'rec_A_o10',
		                  'rec_A_a1', 'rec_A_a2', 'rec_A_a3', 'rec_A_a4', 'rec_A_a5', 'rec_A_a6', 'rec_A_a7', 'rec_A_a8',
		                  'rec_A_a9', 'rec_A_a10',
		                  'rec_A_i1', 'rec_A_i2', 'rec_A_i3', 'rec_A_i4', 'rec_A_i5', 'rec_A_i6', 'rec_A_i7', 'rec_A_i8',
		                  'rec_A_i9']
		visual_names_B = ['real_B', 'fake_A', 'rec_B', 'o1_a', 'o2_a', 'o3_a', 'o4_a', 'o5_a', 'o6_a', 'o7_a', 'o8_a', 'o9_a',
		                  'o10_a',
		                  'a1_a', 'a2_a', 'a3_a', 'a4_a', 'a5_a', 'a6_a', 'a7_a', 'a8_a', 'a9_a', 'a10_a', 'i1_a', 'i2_a', 'i3_a',
		                  'i4_a', 'i5_a',
		                  'i6_a', 'i7_a', 'i8_a', 'i9_a']
		...
		if self.isTrain:
			...
			self.optimizer_G = torch.optim.Adam(itertools.chain(self.netG_A.parameters(), self.netG_B.parameters()), lr=opt.lr,
			                                    betas=(opt.beta1, 0.999))
			self.optimizer_D = torch.optim.Adam(itertools.chain(self.netD_A.parameters(), self.netD_B.parameters()), lr=opt.lr,
			                                    betas=(opt.beta1, 0.999))
	...
	def forward(self):
		...
		self.rec_A_i1, self.rec_A_i2, self.rec_A_i3, self.rec_A_i4, self.rec_A_i5, self.rec_A_i6, self.rec_A_i7, self.rec_A_i8, self.rec_A_i9 = self.netG_B(
